...
def build(source):
    f = open('./data/2019_5_3_19_28_10.json', 'r')
    data = json.loads(f.read())

    # exec_res = source.exec_run(describegraph())
    # data = json.loads(exec_res.output.decode('utf-8'))
    # print(data)
    nodes = data['nodes']
    channels = data['edges']
    ...
    # print(generate_path(1001, path, source))
